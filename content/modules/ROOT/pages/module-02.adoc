...
We should configure a schedule on the workflow to ensure the Application continues to work and have credentials rotated. Log out and back in as 'ztauser', navigate to "Templates" and select our workflow. Select Schedules and create a schedule with the following details:

|===
| Setting | Value
| Schedule Name | App Credential Rotation
| Frequency | minutely
| Interval | 4
|===
Save the rule and continue until the setup is finished.
