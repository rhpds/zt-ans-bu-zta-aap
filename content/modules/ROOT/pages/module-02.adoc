...
== Exercise 2.1 — Build the deployment workflow
...
This template executes first and checks with OPA to ensure the job runs in policy. Next, add to the workflow. Right click on the kebab menu on the template you just added.
...
== Exercise 2.2 — Deny and allow with OPA
...
NOTE: Authentication details: rhel/ansible123!
