...
image::idm-user-groups.png[IdM interface showing user group assignment for neteng user,link=self,window=blank]
...
image::opa-policy-denied.png[Workflow job failure showing OPA policy denial for neteng user,link=self,window=blank]
