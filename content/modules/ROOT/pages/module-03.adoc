...
image::organization-policy-enforcement.png[Organization settings showing policy enforcement configuration with aap/gateway/decision endpoint,link=self,window=blank]
