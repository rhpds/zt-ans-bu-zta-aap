...
Time to simualte an attack and see how EDA can assist without manual intevention. First, navigate to 'Templates' and edit the 'Deploy Application Pipeline' workflow, in Extra variables add the following:
